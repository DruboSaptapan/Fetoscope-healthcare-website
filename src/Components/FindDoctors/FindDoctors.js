        ...
        <div className= "">
            <div className= "container d-flex flex-lg-row flex-column align-items-center mt-5">
                ...
                <div className="col-lg-6 col-12 mt-4 mt-lg-0 ms-3 text-start">
                    <h5 className="find-doctor">Need A Doctor For Free Consult?</h5>
                    <h3 className="w-100">You can find our best qualified doctors for your problem anywhere and anytime</h3>
                    ...
                    <Link to="/doctors"><button className="btn doctor-btn mt-4" type="submit" >Free Consultation</button></Link>
                </div>
            </div>
        </div>
    );
