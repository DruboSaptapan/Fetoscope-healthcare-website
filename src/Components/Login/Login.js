                ...
                <div className="col-md-6 bg-white p-5">
                    ...
                    <div className="form-style">
                        <form>
                            ...
                            <div className="pb-2">
                                <button className="btn btn- w-100 fw-normal mt-2"><FcGoogle style={{}}/> Log in with Google</button>
                            </div>
                        </form>
                        <div className="sideline">OR</div>
                        <div>
                            <button className="btn btn-dark w-100 fw-normal mt-2"> <VscGithubAlt style={{}}/> Log in With Github</button>
                        </div>
                        <div className="pt-4 text-center">
                            Get Members Benefit. <Link href="#">Sign Up</Link>
                        </div>
                    </div>
                </div>
            </div>
